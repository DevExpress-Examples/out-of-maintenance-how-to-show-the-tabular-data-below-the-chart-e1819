...
Namespace ChartAndGridSample
	...
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			CType(chartControl1.Diagram, XYDiagram).AxisX.Visible = False
		...
		Private Sub pivotGridControl1_SizeChanged(ByVal sender As Object, ByVal e As EventArgs)
			AdjustPivotSize(CType(sender, PivotGridControl))
		End Sub
		...
		Private Sub AdjustPivotSize(ByVal pivot As PivotGridControl)
            ...
            columnField.Width = CInt((pivot.ClientSize.Width - rowField.Width - 5) / numberOfYears)
		End Sub
